...
class PrivateRecipeApiTests(TestCase):
    ...
    def test_recipes_limited_to_user(self):
        """Test that user can only access his own recipes"""
    ...
    def test_create_recipe_with_tags(self):
        """Test creating recipe with tags assigned"""
    ...
    def test_partial_update_recipe(self):
        ...
        recipe = sample_recipe(user=self.user)
        recipe.tags.add(sample_tag(user=self.user, name='Spicy'))
    ...
    def test_full_update_recipe(self):
        ...
        payload = {'title': 'Chicken tikka', 'time_minutes': 10, 'price': 5.00}
        url = detail_url(recipe.id)
...
class RecipeImageUploadTests(TestCase):
    ...
    def test_filter_recipes_by_tags(self):
        ...
        recipe2 = sample_recipe(user=self.user, title='Aubergine salmon')
        tag1 = sample_tag(user=self.user, name='Vegan')
    ...
    def test_filter_recipes_by_ingredients(self):
        ...
        ingredient1 = sample_ingredient(user=self.user, name='Salami')
        ingredient2 = sample_ingredient(user=self.user, name='Nooldes')
